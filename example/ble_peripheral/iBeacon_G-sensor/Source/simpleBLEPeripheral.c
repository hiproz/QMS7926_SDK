...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "QST -FFFFFF ";
...
void on_gsensor_evt(gsensor_ev_t* pev)
{
	uint8_t * pdata;
	simpleProfile_Notify( SIMPLEPROFILE_CHAR6, 20, pev->data);
	pdata = pev->data;
	pdata = pdata + 20;
	simpleProfile_Notify( SIMPLEPROFILE_CHAR8, 20, pdata);	
}
