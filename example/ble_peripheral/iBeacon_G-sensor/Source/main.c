...
//    }
	...
	hal_gpio_pin_init(P30,IE);
	hal_gpio_pull_set(P30, FLOATING);
	
	hal_gpio_write(P4, 1);
//	hal_gpio_write(P6, 1);   //当前版本的P6内部与Gsensor int2连接
	hal_gpio_write(P7, 1);
	
	WaitMs(2000);
	
//	hal_gpio_pull_set(P4, FLOATING);
//	hal_gpio_pull_set(P6, FLOATING);
//	hal_gpio_pull_set(P7, FLOATING);
