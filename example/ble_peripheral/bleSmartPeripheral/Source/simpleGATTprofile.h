...
extern bStatus_t simpleProfile_Read( uint16 connHandle, gattAttribute_t *pAttr, 
                            uint8 *pValue, uint8 *pLen, uint16 offset, uint8 maxLen );

extern bStatus_t simpleProfile_Write( uint16 connHandle, gattAttribute_t *pAttr,
