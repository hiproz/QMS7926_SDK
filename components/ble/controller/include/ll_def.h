...
#define LL_CTRL_FEATURE_REQ                      8  // M    , also could be S in ver 4.2  ... HZF
...
#define LL_CTRL_TERMINATE_RX_WAIT_FOR_TX_ACK     14 // M (internal to LL only)
...
typedef struct
{
    uint8_t          rx_timeout;                     // ----- QST    
    uint8_t          rx_crcok;                       // ----- QST
