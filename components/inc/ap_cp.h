...
/*------------- Inter-Integrated Circuit (I2C)  setup by
 * zjp-------------------------------*/
typedef struct {
...
typedef struct {
  __IO uint16_t
      CR0; // 0x0                /*!< Offset: 0x000 Control Register 0 (R/W) */
  uint16_t reserved1;
  __IO uint16_t CR1; // 0x04                 /*!< Offset: 0x004 Control Register
                     // 1 (R/W) */
  uint16_t reserved2;
...
#define CP_PCR_BASE                                                            \
  (0x40020000UL) // change from 0x40020000UL to 0x40000000UL by HZF
